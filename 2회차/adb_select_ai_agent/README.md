...
| `PLS-00684: invalid data type for the JSON return value` | 일부 DB 버전에서 `JSON_OBJECT ... RETURNING CLOB` 조합 제한 | [OAPC 현장 실습 가이드](./OAPC_3rd_Field_Practice_Guide.md)의 빠른 실행 SQL처럼 작은 JSON 문자열을 직접 구성하거나 `VARCHAR2`로 전달 |
